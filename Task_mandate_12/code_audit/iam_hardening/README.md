...
Boundary là HCL động trong `iam_change/main.tf`; không còn JSON template thủ công dễ thiếu ARN. Nó bảo vệ trail, bucket, 9+ rules, 3 Lambda, 3 log groups, 2 alarms, 2 topics, toàn bộ subscription đã confirm, 2 audit roles và đường IAM/STS escalation.
...
**Phiên bản:** v2.0
**Cập nhật:** 21/07/2026
**Trạng thái:** BLOCKED pending IAM inventory/ownership
