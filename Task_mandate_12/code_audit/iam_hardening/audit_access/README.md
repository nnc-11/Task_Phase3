...
Root này dùng backend/state riêng và chỉ deploy sau khi foundation healthy, mỗi topic primary/global/heartbeat-fallback SNS có tối thiểu một email subscription `Confirmed`.
